# -*- coding: utf-8 -*-
"""
Created on Sun Oct 30 22:55:08 2022
...
while number <10:
    number = number + 1
    if number < 10:
        pics.append('face' + '0' + str(number) + '.jpg')
    elif number == 10:
...
for pic in pics:
    if pics == ims_in_dir:
        ...
        print(str(pic) + ' does not exist') # figured this would be a nice touch, had it as an exception but wanted to be safe with what Kyle did in class.
...
accurResp = [0]
accurResp = np.zeros(20)
#-create an empty list for response time collection *
timeResp = [0]
timeResp = np.zeros(20)
